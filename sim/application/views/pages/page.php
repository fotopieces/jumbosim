...
function newMenu(){
	...
	window.location="<?=url::base()?>adminCtrl/newMenu/0";
	
}
function doEditMenu(id){
	//alert(1);
	window.location="<?=url::base()?>adminCtrl/newMenu/"+id;
...
function dodelete(id){
	if(confirm("ต้องการลบข้อมูลหรือไม่")){
		window.location="<?=url::base()?>adminCtrl/delMenu/"+id;
	}
}
		...
		<div class="panel panel-primary">
			<div class="panel-heading">
				<h3 class="panel-title">
					<i class="fa fa-tasks"></i> เมนู
				</h3>
			</div>
			<div class="panel-body">
				<table style="width: 100%" border="1">
<?php 	$listCatalogsim=ORM::factory("pagesim")->where("status","M")->find_all();
$i=1;
