...
<!-- 			ค้นหา<small> เบอร์สวย เบอร์มงคล</small> -->
		...
		<div class="alert alert-dismissable ">
			...
			<p>
			   <form id="saveCatalog" enctype="multipart/form-data" method="post" action="<?=url::base()?>adminCtrl/saveNetwork" >
		...
		<div class="panel panel-primary">
			<div class="panel-heading">
				<h3 class="panel-title">
					<i class="fa fa-tasks"></i> เครื่อข่าย
				</h3>
			</div>
			<div class="panel-body">
				<table style="width: 100%" border="1">
<?php 	$listCatalogsim=ORM::factory("networksim")->find_all();
$i=1;
